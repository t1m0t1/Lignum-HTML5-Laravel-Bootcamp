    ...
    <table class="table" style="opacity: 80%;">
        ...
        <tbody>
            ...
            <tr class="align-middle">
                ...
                <td>
                    <button class="btn btn-success" data-bs-target="#ModalEdit" data-bs-toggle="modal" onclick="editMovie({{$movie->id}})">Edit</button>
                </td>
                <td>
            ...
            <tr class="align-middle">
                ...
                {{-- <td> {{ $movie->mainActor->name }} </td> --}}
                <td>
                    <button class="btn btn-success" data-bs-target="#ModalEdit" data-bs-toggle="modal">Edit</button>
                </td>
                <td>
                    <button class="btn btn-danger" data-bs-target="#ModalDelete" data-bs-toggle="modal">Delete</button> 
                </td>
