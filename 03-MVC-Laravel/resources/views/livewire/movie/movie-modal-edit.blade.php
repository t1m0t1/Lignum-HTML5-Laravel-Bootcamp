...
<div wire:ignore.self class="modal fade" id="ModalEdit-{{$movie->id}}" aria-labelledby="ModalEditLabel-{{$movie->id}}" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content ps-4 pe-4">

        <div class="modal-header" id="edit">
          <h5 class="modal-title" id="ModalEditLabel-{{$movie->id}}">Edit Movie</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
          </button>
        </div>

        <img class="" src="{{asset('images/movies/'.$movie->imageMovie)}}" wire:model="imagePreview" alt="" style=" height: 100%; right: 31em; bottom: auto; position: absolute; ">
        ...
        <div class="modal-body">
          ...
          <form wire:submit.prevent="editMovie" enctype="multipart/form-data">
            ...
            <input class="form-control" type="file" wire:model="movie.imageMovie" accept="image/*" onchange="showFile(event)">
